...
function findOrder(numCourses: number, prerequisites: number[][]): number[] {
    ...
    const ordering = runKahns(courseGraph);
...
console.log(findOrder(numCourses, prerequisites)); // [0,2,1,3] or [0,1,2,3]

numCourses = 1, prerequisites = [];
console.log(findOrder(numCourses, prerequisites)); // [0]

numCourses = 3, prerequisites = [[0,1],[0,2],[1,2]];
console.log(findOrder(numCourses, prerequisites)); // [2,1,0] or [1,2,0]